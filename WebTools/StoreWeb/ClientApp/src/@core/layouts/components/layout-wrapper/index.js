...
const LayoutWrapper = props => {
  // ** Props
  const { layout, children, appLayout, wrapperClass, transition, routeMeta, progress } = props
  ...
  return (
    ...
    >
      <LoadingBar color='#7367f0' progress={progress} transitionTime={200} loaderSpeed={400} waitingTime={800} />
