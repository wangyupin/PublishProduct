...
const CustomGridHeader = React.memo(({ handleFilter, searchTerm, access, handleExcel, handleAdd, addLink, toggleSidebar, children }) => {
                    ...
                    <Row className='m-0'>
                        <Col sm='6' className='d-flex align-items-center p-0'>
                            <InputGroup className='ms-1' style={{ width: 'auto' }}>
                                ...
                                {/* <InputGroupText onClick={toggleSidebar} tag='button'>
                        ...
                        >
                            <div className='d-flex align-items-center table-header-actions'>
                                ...
                                <Button className='me-1' color='primary' onClick={toggleSidebar}> {t('sidebarText', { ns: 'common' })}</Button>
                            </div>
                        </Col>
                    </Row>
                </div >
